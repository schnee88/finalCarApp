<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800">Manas mašīnas</h2>
    </x-slot>

    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <a href="{{ route('cars.create') }}" class="mb-4 inline-block bg-green-500 text-white px-4 py-2 rounded">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="{{ route('cars.show', $car) }}"
                                            class="text-blue-600 hover:text-blue-800 text-m">
                                            Apskatīt pilnībā
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="mt-2 space-y-2">
                                            @foreach($car->comments->take(3) as $comment)
                                                <div class="text-sm text-gray-600 pl-2 border-l-2 border-gray-200">
                                                    ...
                                                    @if($comment->store)
                                                        <p class="text-xs">Veikals: {{ Str::limit($comment->store, 30) }}</p>
                                                    @endif
